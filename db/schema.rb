...
ActiveRecord::Schema.define(version: 20190521215721) do
  ...
  create_table "birthday_parties", force: :cascade do |t|
    ...
    t.date     "end_date",                  default: '2019-06-13', null: false
    t.integer  "location_id"
    t.integer  "complimentary_redemptions", default: 3
  end
  ...
  create_table "credit_card_profiles", force: :cascade do |t|
    t.integer  "user_id"
